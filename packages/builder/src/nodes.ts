...
export const DESTINATION_OPTIONS = [
  { value: "screen", label: "Shown on the agent's screen", description: "a results table your team works from" },
  ...
  { value: "task", label: "A task for a person or another agent", description: "e.g. a Paperclip task" },
];
...
export function baseNodes(ctx: NodeContext): RequirementNode[] {
  ...
  return [
    node({
      ...
      section: "purpose",
      title: "Goal",
      question: "In one or two sentences: what problem should this agent solve, and what does a good result look like?",
    ...
    node({
      ...
      section: "purpose",
      title: "Name",
      question: "What should we call the agent?",
      answerType: "text",
    ...
    node({
      ...
      section: "purpose",
      title: "Out of scope",
      question: "Is there anything the agent must NOT do or decide on its own?",
      why: "Clear boundaries prevent the agent from taking decisions that belong to people.",
      answerType: "text",
    ...
    node({
      ...
      section: "users",
      title: "Users",
      question: "Who will work with the agent's results day to day, and who is accountable for its decisions?",
    ...
    node({
      ...
      question: "Where do the items the agent works on come from today? (pick all that apply)",
    ...
    node({
      ...
      title: "Real examples",
      question:
        "Please upload 3–5 real examples of what the agent will receive (anonymised if needed). I'll analyse formats, languages and content so you don't have to describe them.",
      why: "Real samples reveal edge cases (scans, photos, other languages) that descriptions miss, and become the agent's test cases.",
      answerType: "files",
      recommended: "upload",
    ...
    node({
      ...
      section: "inputs",
      title: "Source system",
      question: "Which business system holds the inputs (product name if you know it), and which records does the agent need?",
      answerType: "text",
    ...
    node({
      ...
      why: "This becomes the agent's form. Keep it short: every field is work for the user.",
      answerType: "fields",
    ...
    node({
      ...
      question:
        "Is there reference information the agent must use to decide (e.g. job descriptions, price lists, policies)? Where does it live?",
      why: "Reference documents go into the agent's knowledge base so it decides like your experts do.",
      answerType: "text",
      prerequisites: ["purpose.goal"],
      priority: 20,
    }),
    ...
    node({
      ...
      question: "Which actions must a person approve before they happen?",
      why: "Approvals keep a human in control of anything that leaves the agent: emails, system updates, decisions about people.",
      answerType: "single",
      options: [
        { value: "external", label: "Everything that leaves the agent (emails, system updates)", description: "recommended to start" },
        { value: "emails", label: "Only outgoing emails" },
        { value: "none", label: "Nothing — fully automatic" },
      ],
    ...
    node({
      ...
      section: "governance",
      title: "Personal data",
      question: "Will the agent see personal data?",
    ...
    node({
      ...
      section: "governance",
      title: "Retention",
      question: "How long may the agent keep the data it processes?",
    ...
    node({
      ...
      question: "Who may see the agent's results?",
      answerType: "text",
    ...
    node({
      ...
      question: "How should your team use the agent?",
    ...
    node({
      ...
      question: "How will you know the agent is working well after a month?",
      answerType: "text",
    ...
    node({
      ...
      question: "In which language should the agent write its results?",
      answerType: "single",
      allowOther: true,
      options: [
...
export function integrationNodes(): RequirementNode[] {
  ...
  return [
    node({
      ...
      question:
        "The agent needs read access to the mailbox (and send/reply rights if it answers). This mailbox isn't connected yet — how should we get access?",
    ...
    node({
      ...
      question: "The agent needs read access to the source system. It isn't connected yet — how should we get access?",
    ...
    node({
      ...
      question: "To write results into the target system the agent needs an integration user with write rights. How should we get it?",
    ...
    node({
      ...
      question: "The agent needs access to the shared folder (SharePoint/OneDrive). How should we get it?",
      kind: "fact",
      answerType: "single",
      options: accessOptions,
      recommended: "ask-it",
    ...
    node({
      ...
      section: "integrations",
      title: "Website form",
      question: "Submissions from the website form must be forwarded to the agent (a webhook). Who maintains the website?",
      kind: "fact",
      answerType: "single",
      options: accessOptions,
      recommended: "ask-it",
        ...
        node(
          {
            ...
            question: "Which kinds of documents will the agent receive?",
            answerType: "text",
            prerequisites: ["purpose.goal"],
            priority: 15,
          },
        ...
        node(
          {
            ...
            section: "actions",
            title: "Replies",
            question: "Should the agent answer emails?",
            answerType: "single",
            options: [

...
import { AgentNotFoundError, PeopleError, RunError, TaskError, type CompanyRow, type Platform } from "@enterprise-brain/runtime";
...
export function statusFor(error: unknown): number {
  ...
  if (error instanceof PeopleError || error instanceof TaskError) return error.status;

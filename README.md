...
8. **Teams** (IT): *Settings → Teams and Chat* walks through connecting your Azure Bot and downloading the Teams app to upload.
...
- **Microsoft Teams** follows the Bot Framework's documentation (signed calls, Universal Actions cards) and is tested against a stand-in Bot Framework, not yet against a live tenant.

Phase 2 is under way: approvals by email, notification preferences and the morning summary, and Microsoft Teams are built. Coming next: Google Chat, calendars, OAuth 2.0 and client certificates for connections, MCP servers, and SFTP and shared folders.

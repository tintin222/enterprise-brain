...
- **Five places, each shown to the people who need it.** *Home*: what needs me, what my AI employees did today, a box to give work. *Company*: departments with their people and AI employees, and each AI employee's page. *Hire*: the Studio and 37 ready-made AI employees. *Work*: every task, and everything that needs a person. *Settings*: connections, Teams and Chat, knowledge, people and roles, costs, audit log, installation.

...
- **Six places, each shown to the people who need it.** *Home*: "What do you need?", what needs me, what my AI employees did today. *Company*: departments with their people and AI employees, and each AI employee's page. *Hire*: the Studio and 37 ready-made AI employees. *Work*: every task, and everything that needs a person. *Apps*: the apps, tables and calculations people built. *Settings*: connections, Teams and Chat, knowledge, people and roles, costs, the rules for building, audit log, installation.
...
9. **Approvals by email**: when an AI employee waits for an approval, the people who may decide it get an email with *Approve*, *Reject* and *Correct it first*. Without a mail connection they land in the demo outbox (*Settings → Mailboxes*); their buttons open a page where you confirm. Your menu (top right) → *What reaches me* sets when and where.
...
11. **Build what you need** (sign in as *Selin Acar*, quality manager): on *Home*, say "I need a supplier complaints register: supplier, order number, problem, status (open, in progress, closed), received on", *Go*, *See the app*, *Make the app*. Then say "File the supplier complaints that come in by email to quality@acme.com.tr into Supplier complaints": its job appears; *Hire it on trial*, *Put it to work*. Send it an email (as *Mehmet Öz*: *Settings → Mailboxes → Simulate incoming email* to quality@acme.com.tr, with lines like `Supplier: Akın Metal`, `Order number: PO-4500051`, `Problem: Cracked flanges`); *Kerem Yıldız* approves the record on his *Home*. Then "Every month, rank suppliers by complaints", *Keep it*. Change anything in plain words from its page ("add a root cause", "this year instead"); IT sees it all in *Settings → Building*.

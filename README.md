...
Phase 2 is under way: approvals by email, notification preferences and the morning summary, Microsoft Teams and Google Chat are built. Coming next: calendars, OAuth 2.0 and client certificates for connections, MCP servers, and SFTP and shared folders.

...
Phase 2 is under way: approvals by email, notification preferences and the morning summary, Microsoft Teams and Google Chat, calendars, and OAuth 2.0 and client certificates for connections are built. Coming next: MCP servers, and SFTP and shared folders.

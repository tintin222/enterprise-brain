...
Phase 2 is under way: approvals by email, notification preferences and the morning summary, Microsoft Teams and Google Chat, and calendars are built. Coming next: OAuth 2.0 and client certificates for connections, MCP servers, and SFTP and shared folders.
